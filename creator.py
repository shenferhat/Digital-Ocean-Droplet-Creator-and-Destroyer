...
if __name__ == '__main__':
    createDropletFromImage("1", "nyc1")
    createDropletFromImage("2", "nyc2")
    createDropletFromImage("3", "nyc3")
    createDropletFromImage("4", "sfo1")
    
    readOpenvpn(str(dropletIPAdress(0)), "1")
    readOpenvpn(str(dropletIPAdress(1)), "2")
    readOpenvpn(str(dropletIPAdress(2)), "3")
    readOpenvpn(str(dropletIPAdress(3)), "4")
